...
myMapApp.viewModel = function() {
    ...
    myMapApp.placeTypes.push({
        displayPlaceType: "Church",
        googleType: "church",
        checkedPlace: ko.observable(true),
        checkedEnable: ko.observable(true),
        placeIcon: "http://maps.google.com/mapfiles/ms/icons/blue-dot.png"
    });
    myMapApp.placeTypes.push({
        displayPlaceType: "Mosque",
        googleType: "mosque",
        checkedPlace: ko.observable(true),
        checkedEnable: ko.observable(true),
        placeIcon: "http://maps.google.com/mapfiles/ms/icons/green-dot.png"
    });
    myMapApp.placeTypes.push({
        displayPlaceType: "Museum",
        googleType: "museum",
        checkedPlace: ko.observable(true),
        checkedEnable: ko.observable(true),
        placeIcon: "http://maps.google.com/mapfiles/ms/icons/orange-dot.png"
    });
    myMapApp.placeTypes.push({
        displayPlaceType: "Place of Worship",
        googleType: "place_of_worship",
        checkedPlace: ko.observable(true),
        checkedEnable: ko.observable(true),
        placeIcon: "http://maps.google.com/mapfiles/ms/icons/pink-dot.png"
    });
    myMapApp.placeTypes.push({
        displayPlaceType: "Synagogue",
        googleType: "synagogue",
        checkedPlace: ko.observable(true),
        checkedEnable: ko.observable(true),
        placeIcon: "http://maps.google.com/mapfiles/ms/icons/yellow-dot.png"
    });
    myMapApp.placeTypes.push({
        displayPlaceType: "Park",
        googleType: "park",
        checkedPlace: ko.observable(true),
        checkedEnable: ko.observable(true),
        placeIcon: "http://maps.google.com/mapfiles/ms/icons/purple-dot.png"
    });
